...
Planning: Outline the project’s roadmap, including timelines, resources, budget, and risk assessment to create a structured approach for development.
...
Changing Requirements:
    ...
    Challenge: Sometimes, what the project needs can change while you’re working on it. This can make things confusing and lead to more work.
...
Technical Debt:
    ...
    Strategy: Make time for code reviews where team members check each other’s work. Regularly go back and clean up the code to improve it.
...
Unit Testing:
    ...
    Importance: Unit testing helps catch bugs early in the development process. If each small part is tested and works well, it’s easier to build a reliable application.
...
System Testing:
    ...
    Importance: This testing is crucial for verifying that the software meets the specified requirements. It ensures that the application behaves as intended from the user’s perspective.
